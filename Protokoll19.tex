...
Bei den anderen zwei Prismen konnte man den Spalt nicht so weit aufdrehen, dass man zwei Linien gesehen hat.
Mit den beiliegenden Blenden haben wir festgestellt, dass die Spaltbreite größer als 2.75 mm sein müsste.

\begin{table}
	\centering
	\begin{tabular}{|c|c|c|c|}
		& theoretischer Wert & leichtes Flintglas		
		\hline
	    Auflösungsvermögen & 274.44 & 81 \pm 17 & 
		\hline
